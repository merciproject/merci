#ifndef MERCITRANSACTION_H
#define MERCITRANSACTION_H
...
class MerciTransaction : public dev::eth::Transaction{

public:

    MerciTransaction() : nVout(0) {}

    MerciTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    MerciTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
