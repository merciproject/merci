...
#include "genesis/merciMainNetwork.cpp"
#include "genesis/merciTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::merciMainNetwork: return c_genesisInfoMerciMainNetwork;
	case Network::merciTestNetwork: return c_genesisInfoMerciTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::merciMainNetwork: return c_genesisStateRootMerciMainNetwork;
	case Network::merciTestNetwork: return c_genesisStateRootMerciTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
