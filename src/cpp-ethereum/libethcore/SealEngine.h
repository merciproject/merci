...
////////////////////////////////////////////////////////////// // merci
	void setMerciSchedule(EVMSchedule _merciSchedule) const { merciSchedule = _merciSchedule; }

	EVMSchedule& getMerciSchedule() const { return merciSchedule; }
...
private:
	...
	mutable EVMSchedule merciSchedule; // merci
