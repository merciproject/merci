#ifndef MERCIVERSIONCHECKER_H
#define MERCIVERSIONCHECKER_H

#include <QObject>

#define MERCI_RELEASES "https://github.com/merciproject/merci/releases"
...
class MerciVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit MerciVersionChecker(QObject *parent = 0);
    ~MerciVersionChecker();
