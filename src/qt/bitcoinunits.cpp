...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MERCI");
    case mBTC: return QString("mMERCI");
    case uBTC: return QString::fromUtf8("μMERCI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Mercis");
    case mBTC: return QString("Milli-Mercis (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Mercis (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
