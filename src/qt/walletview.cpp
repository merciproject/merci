    ...
    platformStyle(_platformStyle)
{
    ...
    MRCTokenPage = new MRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    MRCTokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    MRCTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(MRCTokenPage);
    MRCTokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(MRCTokenPage);
    MRCTokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(MRCTokenPage);
    MRCTokenPage->on_goToAddTokenPage();
}
