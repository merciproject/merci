...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Merci Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Merci Core"
...
#define PACKAGE_BUGREPORT "https://github.com/merciproject/merci/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Merci Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Merci Core 0.16.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "merci"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://mercibq.com/"
