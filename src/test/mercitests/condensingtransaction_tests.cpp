...
BOOST_AUTO_TEST_CASE(condensingtransactionbehavior_tests){
    ...
    for(size_t i = 0; i < 3; i++){
        txs.push_back(createMerciTransaction(code[i], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), i));
        addresses.push_back(createMerciAddress(hashTemp, i));
        ++hashTemp;
    }
    ...
    txs.clear();
    for(size_t i = 0; i < 3; i++){
        txs.push_back(createMerciTransaction(code[i + 3], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[i]));
    }
    ...
    txs.clear();
    txs.push_back(createMerciTransaction(code[6], 8000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
    ...
    txs.clear();
    txs.push_back(createMerciTransaction(code[7], 2000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    txs.push_back(createMerciTransaction(code[8], 2000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
    ...
    txs.clear();
    txs.push_back(createMerciTransaction(code[6], 2000, dev::u256(30000), dev::u256(1), hashTemp, addresses[1]));
    txs.push_back(createMerciTransaction(code[9], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[1]));
    result = executeBC(txs);
    balances = {0,0,0};
    checkRes(result.second, addresses, balances, 2);
...
BOOST_AUTO_TEST_CASE(condensingtransactionbreadthways_tests){
    ...
    txs.push_back(createMerciTransaction(code[10], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 4));
    addresses.push_back(createMerciAddress(hashTemp, 4));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createMerciTransaction(code[0], 15000, dev::u256(500000), dev::u256(1), hashTemp, addresses[3]));
    txs.push_back(createMerciTransaction(code[11], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[3]));
...
BOOST_AUTO_TEST_CASE(condensingtransactiondeep_tests){
    ...
    auto result = executeBC(txs);
    txs.clear();
    txs.push_back(createMerciTransaction(code[11], 20000, dev::u256(500000), dev::u256(1), hashTemp, addresses[4]));
    result = executeBC(txs);
...
BOOST_AUTO_TEST_CASE(condensingtransactionsuicide_tests){
    ...
    std::vector<dev::Address> addresses;
    std::vector<MerciTransaction> txs;
    txs.push_back(createMerciTransaction(code[12], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 0));
    addresses.push_back(createMerciAddress(hashTemp, 0));
    
    txs.push_back(createMerciTransaction(code[17], 0, dev::u256(500000), dev::u256(1), ++hashTemp, dev::Address(), 1));
    txs.push_back(createMerciTransaction(valtype(), 13000, dev::u256(500000), dev::u256(1), hashTemp, createMerciAddress(hashTemp, 1), 1));

    addresses.push_back(createMerciAddress(hashTemp, 1));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createMerciTransaction(code[18], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[1]));
    result = executeBC(txs);
...
BOOST_AUTO_TEST_CASE(condensingtransactionpaytopubkeyhash_tests){
    ...
    txs.push_back(createMerciTransaction(code[19], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 13));
    txs.push_back(createMerciTransaction(valtype(), 13000, dev::u256(500000), dev::u256(1), hashTemp, createMerciAddress(hashTemp, 13), 13));

    addresses.push_back(createMerciAddress(hashTemp, 13));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createMerciTransaction(code[11], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
