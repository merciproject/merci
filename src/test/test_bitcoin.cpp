...
////////////////////////////////////////////////////////////// merci
        ...
        globalState = std::unique_ptr<MerciState>(new MerciState(dev::u256(0), MerciState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::merciTestNetwork)));
