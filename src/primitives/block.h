...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // merci
        hashUTXORoot.SetNull(); // merci
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //merci
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //merci
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //merci
    {
