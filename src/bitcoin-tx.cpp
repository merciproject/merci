...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s merci-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  merci-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded merci transaction") + "\n" +
              "  merci-tx [options] -create [commands]   " + _("Create hex-encoded merci transaction") + "\n" +
              "\n";
