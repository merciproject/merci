...
from test_framework.merciconfig import INITIAL_BLOCK_REWARD
from test_framework.merci import convert_btc_address_to_merci
...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        uncompressed_spendable_address = [convert_btc_address_to_merci("mvozP4UwyGD2mGZU4D2eMvMLPB9WkMmMQu")]
        self.nodes[0].importprivkey("cNC8eQ5dg3mFAVePDX4ddmPYpPbw41r9bm2jd1nLJT77e6RrzTRR")
        compressed_spendable_address = [convert_btc_address_to_merci("mmWQubrDomqpgSYekvsU7HWEVjLFHAakLe")]
        ...
        unknown_address = [convert_btc_address_to_merci("mtKKyoHabkk6e4ppT7NaM7THqPUt7AzPrT"), convert_btc_address_to_merci("2NDP3jLWAFT8NDAiUa9qiE6oBt2awmMq7Dx")]
        ...
        unsolvable_address = [convert_btc_address_to_merci("mjoE3sSrb8ByYEvgnC3Aox86u1CHnfJA4V"), convert_btc_address_to_merci("2N7MGY19ti4KDMSzRfPAssP6Pxyuxoi6jLe"), script_to_p2sh(op1), script_to_p2sh(op0)]
        ...
        uncompressed_spendable_address = [convert_btc_address_to_merci("mguN2vNSCEUh6rJaXoAVwY3YZwZvEmf5xi")]
        self.nodes[0].importprivkey("cMcrXaaUC48ZKpcyydfFo8PxHAjpsYLhdsp6nmtB3E2ER9UUHWnw")
        compressed_spendable_address = [convert_btc_address_to_merci("n1UNmpmbVUJ9ytXYXiurmGPQ3TRrXqPWKL")]
