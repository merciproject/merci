...
"""
class MerciDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the mercid to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    MerciDGPActivation().main()
