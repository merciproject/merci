...
from test_framework.merciconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Merci address", self.nodes[0].createrawtransaction, [], {'foo': 0})
