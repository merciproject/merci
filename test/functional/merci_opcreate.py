...
class OpCreateTest(BitcoinTestFramework):
    ...
    def basic_contract_is_created_raw_tx_test(self):
        ...
        tx = make_transaction(node,
            [make_vin(node, 500000*MERCI_MIN_GAS_PRICE)],
            [make_op_create_output(node, 0, 4, CScriptNum(500000), CScriptNum(MERCI_MIN_GAS_PRICE), bytes.fromhex("60606040523415600b57fe5b5b60398060196000396000f30060606040525b600b5b5b565b0000a165627a7a72305820e3bed070fd3a81dd00e02efd22d18a3b47b70860155d6063e47e1e2674fc5acb0029"))]
        )
