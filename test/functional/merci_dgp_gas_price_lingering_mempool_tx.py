...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see merci-dgp.py
"""
class MerciDGPGasPriceLingeringMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(1)
        self.start_node(1)
        self.nodes[1].createcontract("00", 1000000, MERCI_MIN_GAS_PRICE_STR)
...
if __name__ == '__main__':
    MerciDGPGasPriceLingeringMempoolTxTest().main()
