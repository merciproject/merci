...
class MerciIdenticalRefunds(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.node.sendtocontract(contract_address, "00", 0, 1000000, merci_MIN_GAS_PRICE_STR, sender_address)
        self.node.sendtoaddress(sender_address, 1)
        self.node.sendtocontract(contract_address, "00", 0, 1000000, merci_MIN_GAS_PRICE_STR, sender_address)
