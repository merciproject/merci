...
class MerciNullSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        tx.vout = [CTxOut(0, CScript([b"\x04", CScriptNum(1000000), CScriptNum(MERCI_MIN_GAS_PRICE), b"\x00", OP_CREATE]))]
