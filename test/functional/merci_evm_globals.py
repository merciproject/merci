...
class MerciEVMGlobalsTest(BitcoinTestFramework):
    ...
    def verify_evm_globals_test(self, use_staking=False):
        ...
        """
            ...
            2c7622b0 txorigin()
        """
        self.node.sendtocontract(self.contract_address, "cc5ea9ad", 1, 20000000, MERCI_MIN_GAS_PRICE/COIN, sender)
        ...
        # tx.gasprice
        print('  tx.gasprice')
        assert_equal(MERCI_MIN_GAS_PRICE, int(self.get_contract_call_output("d76c09ad"), 16))
