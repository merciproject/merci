...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # MERCI: Since we enable BIP34 from block 0, this BIP30 test is no longer relevant. This test has therefore been removed.
        # See https://github.com/merciproject/merci_new/blob/master/src/validation.cpp#L1809
        #tip(60)
